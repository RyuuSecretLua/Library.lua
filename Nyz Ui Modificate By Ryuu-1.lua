...
local BG_IMAGE = "rbxassetid://98801320804629"
local LOGO_DECAL = "rbxassetid://88117844324979"
...
function NyzScriptsLibrary:CreateWindow(config)
	...
	TabToggleBtn.Size = UDim2.new(0, 30, 0, 30)
	TabToggleBtn.Position = UDim2.new(0, 5, 0, 5)
	...
	TabSidebar.BackgroundColor3 = Color3.fromRGB(0, 0, 0)
	...
	CloseBtn.MouseButton1Click:Connect(function()
		...
		if isOpen then
			...
			task.delay(0.15, function()
				...
				if sidebarOpen then TabSidebar.Visible = true end
			end)
		else
			CloseBtn.Text = "+"
	...
	function Window:AddTab(tabConfig)
		...
		TabIcon.Size = UDim2.new(1, 0, 0, 30)
		TabIcon.BackgroundColor3 = Color3.fromRGB(30, 22, 22)
		TabIcon.BackgroundTransparency = 0.8
		TabIcon.Text = tabName
		...
		local TabActiveLine = Instance.new("Frame", TabIcon)
		TabActiveLine.Size = UDim2.new(0, 2, 0.6, 0)
		TabActiveLine.AnchorPoint = Vector2.new(0, 0.5)
		TabActiveLine.Position = UDim2.new(0, 0, 0.5, 0)
		TabActiveLine.BackgroundColor3 = YELLOW
		...
		local function activateTab()
			if activeTab then
				local prev = activeTab.Container
				TweenService:Create(activeTab.Icon, TweenInfo.new(0.15), {TextColor3 = GRAY, BackgroundTransparency = 0.8}):Play()
				TweenService:Create(activeTab.Line, TweenInfo.new(0.15), {BackgroundTransparency = 1}):Play()
				TweenService:Create(prev, TweenInfo.new(0.12, Enum.EasingStyle.Quad), {BackgroundTransparency = 1}):Play()
				task.delay(0.12, function() prev.Visible = false end)
			end
			activeTab = {Container = ScrollContainer, Icon = TabIcon, Line = TabActiveLine}
			ScrollContainer.BackgroundTransparency = 1
			ScrollContainer.Visible = true
			TweenService:Create(ScrollContainer, TweenInfo.new(0.18, Enum.EasingStyle.Quad), {BackgroundTransparency = 1}):Play()
			TweenService:Create(TabIcon, TweenInfo.new(0.15), {TextColor3 = YELLOW, BackgroundTransparency = 0.4}):Play()
			TweenService:Create(TabActiveLine, TweenInfo.new(0.15), {BackgroundTransparency = 0}):Play()
		end

		TabIcon.MouseButton1Click:Connect(activateTab)
		if #tabs == 0 then activateTab() end
		table.insert(tabs, {Container = ScrollContainer, Icon = TabIcon, Line = TabActiveLine})
		...
		function Tab:AddSection(secConfig)
			...
			secLine.BackgroundColor3 = YELLOW
		...
		function Tab:AddButton(btnConfig)
			...
			btn.MouseButton1Click:Connect(function()
				...
				task.delay(0.2, function()
					TweenService:Create(rStroke, TweenInfo.new(0.2), {Transparency = 0.4}):Play()
				end)
				callback()
			end)
		end
		...
		function Tab:AddToggle(togConfig)
			...
			toggleTrack.BackgroundColor3 = Color3.fromRGB(50, 40, 40)
			...
			local function updateVisual(s)
				if s then
					TweenService:Create(toggleTrack, TweenInfo.new(0.2), {BackgroundColor3 = Color3.fromRGB(100, 70, 0)}):Play()
					TweenService:Create(trackStroke, TweenInfo.new(0.2), {Transparency = 0}):Play()
					TweenService:Create(knob, TweenInfo.new(0.2), {Position = UDim2.new(0, 21, 0.5, -9), BackgroundColor3 = YELLOW}):Play()
				else
					TweenService:Create(toggleTrack, TweenInfo.new(0.2), {BackgroundColor3 = Color3.fromRGB(50, 40, 40)}):Play()
					TweenService:Create(trackStroke, TweenInfo.new(0.2), {Transparency = 0.65}):Play()
		...
		function Tab:AddSlider(sliderConfig)
			...
			sliderBg.Size = UDim2.new(0, 145, 0, 24)
			...
			trackBg.Size = UDim2.new(1, -46, 0, 6)
			trackBg.Position = UDim2.new(0, 42, 0.5, -3)
			trackBg.BackgroundColor3 = Color3.fromRGB(40, 30, 30)
			...
			trackFill.BackgroundColor3 = YELLOW
		...
		function Tab:AddDropdown(dropConfig)
			...
			dropList.BackgroundColor3 = Color3.fromRGB(12, 9, 9)
			dropList.BackgroundTransparency = 0.35
