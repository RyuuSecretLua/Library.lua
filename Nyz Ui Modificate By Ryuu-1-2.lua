	...
	function Window:AddTab(tabConfig)
		...
		local function activateTab()
			if activeTab then
				...
				TweenService:Create(activeTab.Icon, TweenInfo.new(0.2), {TextColor3 = GRAY, BackgroundTransparency = 0.8}):Play()
				TweenService:Create(activeTab.Line, TweenInfo.new(0.2), {BackgroundTransparency = 1}):Play()
				TweenService:Create(prev, TweenInfo.new(0.18, Enum.EasingStyle.Quad), {GroupTransparency = 1}):Play()
				task.delay(0.18, function() prev.Visible = false prev.GroupTransparency = 0 end)
			end
			activeTab = {Container = ScrollContainer, Icon = TabIcon, Line = TabActiveLine}
			ScrollContainer.GroupTransparency = 1
			ScrollContainer.Visible = true
			TweenService:Create(ScrollContainer, TweenInfo.new(0.25, Enum.EasingStyle.Quad), {GroupTransparency = 0}):Play()
			TweenService:Create(TabIcon, TweenInfo.new(0.2), {TextColor3 = YELLOW, BackgroundTransparency = 0.4}):Play()
